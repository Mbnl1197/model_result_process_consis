...
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_1month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_2month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_3month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_4month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_5month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_6month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_7month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_8month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_9month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_10month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_11month.csv',index_col=0)
brc_30 = pd.read_csv('/stu01/shijh21/liuz/sis/bias_rmse_corr_12month.csv',index_col=0)
...
im, cbar,axx = heatmap(bias, row_labels,col_labels, ax=ax[0],
                   cmap=cmap, aspect='auto',cbarlabel="BIAS")
texts = annotate_heatmap(im, valfmt="{x:.1f}",fontsize = 20)
ax[0].set_title("Bias", x=0.5, y=1.07, fontsize=30, color='red')



im, cbar,axx = heatmap_rmse(rmse, row_labels,col_labels, ax=ax[1],
                   cmap='GnBu', aspect='auto',cbarlabel="RMSE")
texts = annotate_heatmap(im, valfmt="{x:.1f}",fontsize = 20)
ax[1].set_title("RMSE", x=0.5, y=1.07, fontsize=30, color='red')


im, cbar,axx = heatmap_corr(corr, row_labels,col_labels, ax=ax[2],
                   cmap='GnBu', aspect='auto',cbarlabel="Corr")
texts = annotate_heatmap(im, valfmt="{x:.1f}",fontsize = 20)
ax[2].set_title("Corr", x=0.5, y=1.07, fontsize=30, color='red')




fig.suptitle(f"{month} month", x=0.5, y=1.05, fontsize=40, color='red')
